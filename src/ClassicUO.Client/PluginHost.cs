...
#pragma warning restore CS0169
        ...
        {
            return PacketsTable.GetPacketLength(id);
        }
...
#pragma warning restore CS0618
                ...
                case 3:
                    ...
                    var res = Pathfinder.AutoWalking;

                    switch (subCmd.Item2)
                    {
                        case -1: return (IntPtr)Unsafe.AsPointer(ref res);
                        case 0:
                            Pathfinder.AutoWalking = false;
                            break;
                        default:
                            Pathfinder.AutoWalking = true;
                            break;
                    }
                ...
                case 4:
                    ...
                    bool started = Pathfinder.WalkTo(args.Item2, args.Item3, args.Item4, args.Item5);
